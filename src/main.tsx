...
import type { ConnectionKind } from "./components/ConnectionStatus";
...
// still renders and ConnectionStatus reflects the final backend.
...
async function chooseBackend(): Promise<BackendChoice> {
...
void chooseBackend().then(({ store, kind }) => {
  mountApp(root, store, kind);
});